...
| BLE transport reference | [`../transports/ble-gatt.md`](../transports/ble-gatt.md) | Stable reference reconciled with this report |
| Updater binaries | See [`reverse-engineering-provenance.md`](reverse-engineering-provenance.md) | Summarized |
| Historical session DB snapshot | external / private; summarized in [`reverse-engineering-provenance.md`](reverse-engineering-provenance.md) | Not included |
...
The canonical list of retracted claims and their replacements is maintained in [`corrections.md`](corrections.md). This dated report retains the chronology and experimental confounds that produced those corrections.
